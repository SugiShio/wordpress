<?php
function yf_scripts() {
  wp_enqueue_style('my-style', get_template_directory_uri() . '/public/css/style-1.0.5.css');
  wp_enqueue_script('my-scripts', get_template_directory_uri() . '/public/js/index-1.0.5.js');
}
